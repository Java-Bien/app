...
public class Professeur {
    ...
    public Professeur(IntegerProperty id, StringProperty nom, StringProperty prenom, StringProperty specialite) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.specialite = specialite;
    ...
    public void ajouterSeance(Seance seance) throws Exception {
    	if (seance.getCours().getType().get().equals(this.specialite.get())) {
            boolean ok = true;
